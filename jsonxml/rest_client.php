...
if(isset($_GET["action"]) == "get_student"){
    ...
    $student_info = file_get_contents('http://localhost:8080/jsonxml/api.php?action=get_student&id=' . $_GET["id"]);
...
<?php
 ...
 
 {
    ...
    $student_list = file_get_contents('http://localhost:8080/jsonxml/api.php?action=get_student_list');
...
<a href=<?php echo
"http://localhost:8080/jsonxml/rest_client.php?action=get_student&id=" . $student["id"] ?>><?php echo $student["name"] ?></a><br />
